...
export class ComponentListDrawer {
    ...
    getList = function () {
        ...
        if (dataSource.entityType === 'department') {
            const departmentHead = $('<tr><th><h2>Id</h2></th><th><h2>Department name</h2></th><th colspan="3"><h2>Options<h2/></th></tr>>');
            const departmentList = _.template('<% _.each(data, function(e) {%> ' +
            ...
            const employeeList = _.template('<% _.each(data, function(e) {%> ' +
